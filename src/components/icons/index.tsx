...
function InboxIcon(props: JSX.IntrinsicElements['svg']) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
function PhoneIcon(props: JSX.IntrinsicElements['svg']) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
function RightArrowIcon(props: JSX.IntrinsicElements['svg']) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
function CollectionIcon(props: JSX.IntrinsicElements['svg']) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
function JobHistoryIcon(props: JSX.IntrinsicElements['svg']) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
function PendingOffersIcon(props: JSX.IntrinsicElements['svg']) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
function TicketIcon(props: JSX.IntrinsicElements['svg']) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
function SelectorIcon(props: JSX.IntrinsicElements['svg']) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
